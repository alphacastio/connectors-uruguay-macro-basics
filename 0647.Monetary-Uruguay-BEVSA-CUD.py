...
# path = "..//Input/Conector 647/cud.xlsx"
# df = pd.read_excel(path)
# df = df.rename(columns={'FECHA':'Date'})
# df = df.set_index('Date')
# df = df.sort_index(ascending=True)

path = "..//Input/Conector 647/cud.csv"
df = pd.read_csv(path)
df = df.rename(columns={'FECHA':'Date'})
df = df.set_index('Date')
...
url = "https://web.bevsa.com.uy/CurvasVectorPrecios/CurvasIndices/Historico.aspx?I=CUD"
...
df3.to_csv("..//Input/Conector 647/cud.csv")
df3["country"] = "Uruguay"


alphacast.datasets.dataset(647).upload_data_from_df(df3, 
